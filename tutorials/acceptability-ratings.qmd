...
For the assumptions of linear mixed models, see:
https://vasishth.github.io/Freq_CogSci/checking-model-assumptions.html
but also @schielzeth2020robustness.
```{r, message=FALSE}
library(lmerTest)
...
##### Note
If word_order has more than two levels (e.g. SOV, SVO, VSO) and you need pairwise comparisons:
```{r, message=FALSE}
library(emmeans)
# you need to choose the right adjustment family depending on your data
